...
(function (global) {
  ...
  */
  ...
  async function drawFocusMap(vehicleId) {
    ...
    const currentPlanner = global.V90Planner || global.V65Planner || global.V64Planner;
  ...
  function createSortable(element, vehicleId, focus = false) {
    ...
    return new Sortable(element, {
      ...
      onEnd: event => {
        ...
        const buildManual = global.V90Planner?.buildManualRouteV55 || global.V55Planner?.buildManualRouteV55;
        setTimeout(async () => {
