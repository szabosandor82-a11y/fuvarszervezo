const CACHE_NAME = 'fuvarszervezo-v47-online-20260806-4';
const APP_ASSETS = [
  './', './index.html', './styles.css?v=47', './app.js?v=47', './data.js?v=47',
  './planner-v32.js?v=47', './planner-v33.js?v=47', './planner-v34.js?v=47',
  './planner-v35.js?v=47', './planner-v37.js?v=47', './planner-v41.js?v=47',
  './planner-v43.js?v=47', './planner-v44.js?v=47', './auth-v44-2.js?v=47',
  './online-config.js?v=47', './online-v44-2.js?v=47',
  './ole-msg-reader.js?v=47', './manifest.webmanifest', './icon-192.png', './icon-512.png'
];
