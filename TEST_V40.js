...
vm.runInThisContext(fs.readFileSync(__dirname + '/planner-v40.js','utf8'), {filename:'planner-v40.js'});
...
test('Szerelvénybolt címmigráció', () => { V.migrateV40MasterData(); eq(state.suppliers.find(x=>x.id==='s-szer').address,'1182 Budapest, Üllői út 807/B'); });
...
console.log(`\nV40 teszt: ${passed}/${passed+failed} sikeres.`);
