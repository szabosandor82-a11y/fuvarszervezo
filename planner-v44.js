  ...
  */
  ...
  async function roadMatrixV49(points) {
    ...
    try {
      ...
      console.warn('[V87] Közúti mátrix nem elérhető; légvonalas tartalék használata.', error);
    }
    return fallback;
  }
  ...
  */
  ...
  async function balanceActionV44() {
    try {
      ...
      alert(`Fuvarok V87 szerint szétosztva és felrakási sorrendbe rendezve.\n${result.summary}${conflictText}\nAzonos beszállító egy sofőrnél marad. A lerakók nem részei az optimalizálásnak.`);
      return result;
    } catch (error) {
      console.error('[V87] Szétosztási hiba', error);
  ...
  async function optimizeActionV44() {
    try {
      ...
      await persistOnlineV49();
      if (typeof render === 'function') render();
      alert('V87 optimalizálás elkészült: kizárólag a felrakók sorrendje változott. Lerakó és sofőr nem változott.');
      return true;
    } catch (error) {
      console.error('[V87] Optimalizálási hiba', error);
  ...
  */
  ...
  function bindV44() {
    ...
    if (balanceButton) {
      ...
      balanceButton.title = 'V87: sáv-alapú szétosztás; Márió=észak/kelet Pest, Patrik=közép/dél Pest és Buda, Martin=5-6 m szálanyag';
    }
    if (optimizeButton) {
      ...
      optimizeButton.title = 'V87: lakhely -> felrakók -> lerakók lánc optimalizálása, sofőrváltás nélkül';
    }
  ...
  global.V86Planner = global.V87Planner;
  global.V85Planner = global.V87Planner;
  global.V84Planner = global.V87Planner;
  global.V83Planner = global.V87Planner;
  global.V82Planner = global.V87Planner;
  global.V81Planner = global.V87Planner;
  global.V80Planner = global.V87Planner;
  global.V79Planner = global.V87Planner;
  global.V78Planner = global.V87Planner;
  global.V77Planner = global.V87Planner;
  global.V76Planner = global.V87Planner;
  global.V75Planner = global.V87Planner;
  global.V74Planner = global.V87Planner;
  global.V73Planner = global.V87Planner;
  global.V72Planner = global.V87Planner;
  global.V71Planner = global.V87Planner;
  global.V70Planner = global.V87Planner;
  global.V69Planner = global.V87Planner;
  global.V66Planner = global.V87Planner;
  global.V65Planner = global.V87Planner;
  global.V64Planner = global.V87Planner;
  global.V63Planner = global.V87Planner;
  global.V62Planner = global.V87Planner;
  global.V61Planner = global.V87Planner;
  global.V60Planner = global.V87Planner;
  global.V59Planner = global.V87Planner;
  global.V58Planner = global.V87Planner;
  global.V57Planner = global.V87Planner;
  global.V56Planner = global.V87Planner;
  global.V55Planner = global.V87Planner;
  global.V54Planner = global.V87Planner;
  global.V53Planner = global.V87Planner;
  global.V50Planner = global.V87Planner;
  global.V49Planner = global.V87Planner;
  global.V44Planner = global.V87Planner;
