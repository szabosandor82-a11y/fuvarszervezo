  ...
  */
  ...
  async function roadMatrixV49(points) {
    ...
    try {
      ...
      console.warn('[V78] Közúti mátrix nem elérhető; légvonalas tartalék használata.', error);
    }
    return fallback;
  }
  ...
  */
  ...
  async function balanceActionV44() {
    try {
      ...
      alert(`Fuvarok V78 szerint szétosztva és felrakási sorrendbe rendezve.\n${result.summary}${conflictText}\nAzonos beszállító egy sofőrnél marad. A lerakók nem részei az optimalizálásnak.`);
      return result;
    } catch (error) {
      console.error('[V78] Szétosztási hiba', error);
  ...
  async function optimizeActionV44() {
    try {
      ...
      await persistOnlineV49();
      if (typeof render === 'function') render();
      alert('V78 optimalizálás elkészült: kizárólag a felrakók sorrendje változott. Lerakó és sofőr nem változott.');
      return true;
    } catch (error) {
      console.error('[V78] Optimalizálási hiba', error);
  ...
  */
  ...
  function bindV44() {
    ...
    if (balanceButton) {
      ...
      balanceButton.title = 'V78: sáv-alapú szétosztás; Márió=észak/kelet Pest, Patrik=közép/dél Pest és Buda, Martin=5-6 m szálanyag';
    }
    if (optimizeButton) {
      ...
      optimizeButton.title = 'V78: lakhely -> felrakók -> lerakók lánc optimalizálása, sofőrváltás nélkül';
    }
  ...
  global.V77Planner = global.V78Planner;
  global.V76Planner = global.V78Planner;
  global.V75Planner = global.V78Planner;
  global.V74Planner = global.V78Planner;
  global.V73Planner = global.V78Planner;
  global.V72Planner = global.V78Planner;
  global.V71Planner = global.V78Planner;
  global.V70Planner = global.V78Planner;
  global.V69Planner = global.V78Planner;
  global.V66Planner = global.V78Planner;
  global.V65Planner = global.V78Planner;
  global.V64Planner = global.V78Planner;
  global.V63Planner = global.V78Planner;
  global.V62Planner = global.V78Planner;
  global.V61Planner = global.V78Planner;
  global.V60Planner = global.V78Planner;
  global.V59Planner = global.V78Planner;
  global.V58Planner = global.V78Planner;
  global.V57Planner = global.V78Planner;
  global.V56Planner = global.V78Planner;
  global.V55Planner = global.V78Planner;
  global.V54Planner = global.V78Planner;
  global.V53Planner = global.V78Planner;
  global.V50Planner = global.V78Planner;
  global.V49Planner = global.V78Planner;
  global.V44Planner = global.V78Planner;
