const KEY='fuvarszervezo_v11';const APP_VERSION=(()=>{const v=window.V88Planner?.version||window.V55Planner?.version||window.V54Planner?.version||window.V53Planner?.version||'';return v?('V'+v):'V55'})();const $=s=>document.querySelector(s),$$=s=>document.querySelectorAll(s);
